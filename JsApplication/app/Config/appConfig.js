(function () {
    ...
    var settings = {
        ...
        scope: "openid profile email api read write",
    ...
    angular.module('myApp').value('oidcManager', manager);

    angular.module('myApp').factory('httpInterceptor', ['$q', '$rootScope', '$log', '$timeout', 'localStorageService',
    ...
    myApp.run(['oidcManager', function (oidcManager) {
        oidcManager.oidcClient.loadMetadataAsync();
    }]);
})();